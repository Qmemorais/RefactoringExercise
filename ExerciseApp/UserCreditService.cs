...
namespace ExerciseApp
{
    ...
    [ServiceContract(ConfigurationName =  "ExerciseApp.IUserCreditService")]
    public interface IUserCreditService
    {
        [OperationContract(Action = "http://example-credit-service.com/IUserCreditService/GetCreditLimit")]
